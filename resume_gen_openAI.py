...
# Import job description and examples
...
def optimize_resume(raw_resume_path: str, job_description: str, output_path: str):
    raw_resume_text = load_raw_resume(raw_resume_path)
    few_shot_prompt = create_few_shot_prompt(RESUME_EXAMPLES)
...
if __name__ == "__main__":
    optimize_resume("resume-prompt.json", JOB_DESCRIPTION, "optimized_resume.json")
